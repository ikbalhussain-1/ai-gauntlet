...
| GET /results: no data after 90s (is Claude API key set and analysis running?) | FAIL | 0 |
...
| 3/5 tests pass | PASS | +4 |
| 2 test(s) still failing | FAIL | 0 |
...
| Strong commit history (5 commits) | PASS | +2 |
| 0 | NOTE | - |
